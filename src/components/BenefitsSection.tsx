...
const benefits = [
  {
    icon: Heart,
    title: "Heart Health",
    description: "Rich in antioxidants that support cardiovascular health and reduce cholesterol",
  },
  {
    icon: Zap,
    title: "Energy Boost",
    description: "Natural sugars and iron provide sustained energy throughout the day",
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    description: "B vitamins and magnesium support cognitive health and mental clarity",
  },
  {
    icon: Sparkles,
    title: "Skin Health",
    description: "Antioxidants and vitamin E promote youthful, glowing skin",
  },
  {
    icon: Apple,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-20 grid sm:grid-cols-2 lg:grid-cols-4 gap-8 animate-fade-up" style={{ animationDelay: "0.4s" }}>
          {[
            ...
            { value: "50+", label: "Hectares Farmed" },
          ].map((stat) => (
